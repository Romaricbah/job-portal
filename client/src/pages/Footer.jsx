          ...
          <div className="flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                The information provided on this platform is for general informational purposes  and does not constitute legal or financial advice
                </p>
